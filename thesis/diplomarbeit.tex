...
\usepackage[utf8x]{inputenc} %von Lisa hinzugefügt
%\usepackage[postscript]{ucs} %von Lisa hinzugefügt
%\usepackage{textcomp} %von Lisa hinzugefügt
%\usepackage{newunicodechar} %von Lisa hinzugefügt
%\newunicodechar{〈}{\langle} %von Lisa hinzugefügt
...
\hypersetup
	{%
	pdfsubject = {Bestimmung der Dokumentenähnlichkeit basierend auf Bayesscher Statistik für eine Big-Data Information Retrieval Lösung},
...
\newpage
\input{introduction/einleitung}
\input{fundamentals/Grundlagen}
\input{relatedworks/BD4B}
\input{specification/Auswahl}
\input{design/Implementierung}
\input{implementation/Evaluierung}
\input{validationEvaluation/Zusammenfassung}
